         ...
         <div className=" relative float-left h-full cursor-pointer ">
            <Link href={"/products/" + data.seo} legacyBehavior>
               <div className="w-full float-left">
                  <div className="w-5/12 float-left relative ">
                     {/* <span
                        ...
                        } absolute z-10 top-0 mt-2 text-xs float-left py-1 px-2 bg-seconday text-white`}
                     >
                        {settings.price_type
                ...
                discount
                     ...
                     <Image
                        ...
                        width="143"
                        height="143"
                        alt={data.title? data.title : "Default Title"}
                     />
              ...
              */}
                     ...
                     <Button className="!bg-primary  rounded-r rounded-t-none !rounded-b-none !rounded-l   absolute bottom-0 right-0 b  group-hover:text-white group-hover:shadow-lg text-white">
                Details
                     </Button>
                  </div>
               </div>
